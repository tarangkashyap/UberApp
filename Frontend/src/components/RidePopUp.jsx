  ...
  return (
    <div>
      ...
      <div className="w-full mt-5">
        ...
        <button
        onClick={() => setridePopupPanel(false)}
        className=" w-full mt-2 bg-gray-300 text-gray-700 font-semibold p-3 px-10 rounded-lg"
      >
        Ignore
      </button>
      ...
      <button
        onClick={() => {
          setConfirmRidePopupPanel(true); // Show Confirm Ride
          setridePopupPanel(false); // Hide Ride Popup
        }}
        className="w-full mt-2 bg-green-600 text-lg text-white font-semibold p-3 rounded-lg">
        Accept
      </button>
